...
var TxtRotate = function (el, toRotate, period, tempo) {
...
//  this.el.innerHTML = '<span class="wrap">' + this.txt + "</span>";
  ...
  var that = this;
  var delta = Math.random() * this.tempo
...
window.onload = function () {
  ...
  for (var i = 0; i < elements.length; i++) {
    ...
    var tempo = elements[i].getAttribute("data-tempo"); // high number == slow, small number == fast
    if (toRotate) {
      new TxtRotate(elements[i], JSON.parse(toRotate), period, parseFloat(tempo));
    }
  }
  // INJECT CSS
